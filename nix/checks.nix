        ...
        home-manager-module =
          let
            enabled = evalHomeModule {
              ...
              hermesHomeDocuments."SOUL.md" = "test soul";
            ...
            failures =
              ...
              ) "hermesHomeDocuments must install into HERMES_HOME"
              ++ lib.optional (
                !lib.hasInfix "/home/hermes-check/AGENTS.md" activation
        ...
        nixos-module =
          ...
          pkgs.runCommand "hermes-nixos-module" { } (
            if failures != [ ] then
              ...
              throw "NixOS module check failed:\n  - backend.mode with container.enable should be rejected by an assertion"
            else
              ''
